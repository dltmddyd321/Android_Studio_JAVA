...
public class Girlhow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_girlhow);
        setTitle("선택 필터");
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(),"이미 여성 검색창입니다.",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(),"남성 검색창입니다.",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(chk2.isChecked() == true && chk6.isChecked() == true){
                    Intent intent = new Intent(getApplicationContext(),Girlshops1.class);
                    startActivity(intent);
                }else
